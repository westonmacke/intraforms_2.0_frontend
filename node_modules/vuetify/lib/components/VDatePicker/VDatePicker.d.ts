...
export declare const makeVDatePickerProps: <Defaults extends {
    ...
    monthText: unknown extends Defaults["monthText"] ? StringConstructor : {
        type: import("vue").PropType<unknown extends Defaults["monthText"] ? string : string | Defaults["monthText"]>;
    ...
    yearText: unknown extends Defaults["yearText"] ? StringConstructor : {
        type: import("vue").PropType<unknown extends Defaults["yearText"] ? string : string | Defaults["yearText"]>;
